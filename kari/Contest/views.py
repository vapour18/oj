...
from Contest.models import Contest, ContestProblem, ContestNotice
from Contest.forms import contestForm, contestNoticeForm
...
def showContest(request, cId):
    try:
        ...
        return render(request, 'newtpl/contest/showContest.html',
                {'contest': c, 'problem_list': problemList, 'contest_notice_list': cn,
                 'ccid': c.course_class.id, 'tpl':{'has_priv': priv, 'nav_act':'contest',}})
    except Exception as e:
