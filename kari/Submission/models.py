...
class Submission( models.Model):
    ...
    problem_index = models.ForeignKey( 'Contest.ContestProblem', verbose_name='problem index in the corresponding contest')
    ...
    @classmethod
    def submissionList(cls, u=None, c=None, cp=None, uname=None, lang=None, sta=None):
        """
        return the submission list filter by params
        """

        try:
            s = cls.objects.select_related('user', 'problem_index')
            if cp:
...
#debug 
    ...
    @classmethod
    def generalSubmissionList( cls, u=None, p=None, uname=None, language=None, status_selected=None):
        """
